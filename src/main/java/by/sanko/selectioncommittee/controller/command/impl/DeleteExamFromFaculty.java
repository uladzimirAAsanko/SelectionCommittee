...
public class DeleteExamFromFaculty implements Command {
    ...
    private static final String POSITIVE_ANSWER = "Exam is successfully deleted";
    private static final String NEGATIVE_ANSWER = "This exam is never been added";
    ...
    public void execute(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        ...
        String answer = "";
        try {
            if(facultyService.deleteExamFromFaculty(exam,facultyID)){
